...
const translations = {
  enlang: {
    ...
    sert6:
      'Certificate held by the Triple "J" Vocational High School Education and Skills Institute regarding the assessment of English language skills.',
    ...
    sked4:
      "The soft skills and hard skills that I have gained from various companies where I have worked include :",
    ...
    contact1: "Address",
    contact2:
      "Street Hambalang village RT 005 RW 002 Citeureup sub-district Bogor regency postal code 16810",
    contact3: "Phone",
  },
  idlang: {
    ...
    sert6:
      'Sertifikat yang dimiliki oleh Lembaga Pendidikan dan Keterampilan SMK Triple "J" mengenai penilaian kemampuan berbahasa Inggris.',
    ...
    sked4:
      "Adapun softskill dan hardskill yang saya peroleh dari berbagai perusahaan tempat saya bekerja antara lain :",
    ...
    contact1: "Alamat",
    contact2:
      "Jalan. Kp. Hambalang RT. 005 RW. 002 Kecamatan Citeureup Kabupaten Bogor Kode Pos 16810",
    contact3: "Telepon",
  },
};
...
let memet3 = document.getElementById("memet-3");
...
const setLanguage = (language) => {
  if (language == "idlang") {
    ...
    memet3.innerText = translations.idlang.memet3;
    ...
    memet3.innerText = translations.enlang.memet3;
...
document.getElementById("eForm").addEventListener("submit", function (event) {
  ...
  const serviceID = "service_qprz0ux";
  const templateID = "template_5xvxbx2";
